...
function Login() {
    ...
    return(
        <div className="dropdown">
            <button className="btn btn-lg btn-dark dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Login</button>
